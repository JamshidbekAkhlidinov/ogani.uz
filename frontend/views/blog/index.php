                    ...
                    <div class="blog__sidebar">
                        ...
                        <div class="blog__sidebar__item">
                            ...
                            <div class="blog__sidebar__recent">
                                <a href="<?=url::to(['blog/blog-details'])?>" class="blog__sidebar__recent__item">
                ...
                <div class="col-lg-8 col-md-7">
                    <div class="row">
                            ...
                            <div class="blog__item">
                                ...
                                <div class="blog__item__text">
                                    ...
                                    <p>Sed quia non numquam modi tempora indunt ut labore et dolore magnam aliquam
                                        quaerat </p>
                                    <a href="<?=url::to(['blog/blog-details'])?>" class="blog__btn">READ MORE <span class="arrow_right"></span></a>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-6 col-md-6 col-sm-6">
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-6">
                            <div class="blog__item">
                                <div class="blog__item__pic">
                                    <img src="<?=url::to('@web/img/blog/blog-4.jpg')?>" alt="">
                                </div>
                                <div class="blog__item__text">
                                    <ul>
                                        <li><i class="fa fa-calendar-o"></i> May 4,2019</li>
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-6">
                            <div class="blog__item">
                                <div class="blog__item__pic">
                                    <img src="<?=url::to('@web/img/blog/blog-6.jpg')?>" alt="">
                                </div>
                                <div class="blog__item__text">
                                    <ul>
                                        <li><i class="fa fa-calendar-o"></i> May 4,2019</li>
